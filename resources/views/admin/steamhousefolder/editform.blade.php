...
<div class="card-body">
    ...
    <div class="row mb-6">
        ...
        <div class="col-lg-4 fv-row">
                {!! Form::text('pressure', null, ['min' => 2, 'max' => 6, 'value' => 2, 'class' => 'form-control form-control-lg form-control-solid', 'placeholder' => trans_choice('content.pressures', 1)]) !!}
        </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-lg-4 fv-row">
                {!! Form::text('totalizer', null, ['min' => 2, 'max' => 6, 'value' => 2, 'class' => 'form-control form-control-lg form-control-solid', 'placeholder' => trans_choice('content.totalizers', 1)]) !!}
        </div>
...
@push('scripts')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Admin\SteamHouseRequest', 'form') !!}
