                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column flex-lg-row mb-17">
                        ...
                        <div class="flex-lg-row-fluid me-0 me-lg-20">
                            <!--begin::Form-->
                            {!! Form::model($user, ['method' => 'PATCH', 'route' => ['admin.companylists.update', $user->id], 'class' => 'form mb-15', 'enctype' => 'multipart/form-data']) !!}
                            @csrf
                            <input type="hidden" name="id" value="{{$user->id}}">
                            @include('admin.companylistfolder.editform')
                            <!--begin::Actions-->
