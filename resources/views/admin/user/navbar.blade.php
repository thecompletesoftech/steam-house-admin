    ...
    <div class="card-body pt-9 pb-0">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="svg-icon svg-icon-3 svg-icon-success me-2">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <polygon points="0 0 24 0 24 24 0 24" />
                                                <rect fill="#000000" opacity="0.5" x="11" y="5" width="2" height="14"
                                                    rx="1" />
                                                <path
        ...
        <div class="d-flex overflow-auto h-55px">
            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
                <!--begin::Nav item-->
                <li class="nav-item">
                    <a class="nav-link text-active-primary me-6 {{ request()->tab == 'details' || request()->tab == '' ? 'active' : '' }}"
                        href="{{ route('admin.users.show', $user->id) }}?tab=details">Profile</a>
                </li>
                <!--end::Nav item-->
                <!--begin::Nav item-->
                <li class="nav-item">
                    <a class="nav-link text-active-primary me-6 {{ request()->tab == 'edit' || request()->tab == '' ? 'active' : '' }}"
                        href="{{ route('admin.users.edit', $user->id) }}?tab=edit">Edit Profile</a>
                </li>
                <!--end::Nav item-->
            </ul>
        </div>
